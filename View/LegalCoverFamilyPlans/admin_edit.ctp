...
<?php echo $this->Form->create('LegalCoverFamilyPlan'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Legal Cover Family Plan'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LegalCoverFamilyPlan.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('LegalCoverFamilyPlan.id'))); ?></li>
