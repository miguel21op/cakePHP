...
<?php echo $this->Form->create('LegalCoverFamilyCoverage'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Legal Cover Family Coverage'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LegalCoverFamilyCoverage.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('LegalCoverFamilyCoverage.id'))); ?></li>
