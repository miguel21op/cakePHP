...
<?php echo $this->Form->create('LegalCoverFamilyQuoteRequest'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Legal Cover Family Quote Request'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LegalCoverFamilyQuoteRequest.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('LegalCoverFamilyQuoteRequest.id'))); ?></li>
